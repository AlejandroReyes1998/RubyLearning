...
class RegistrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create registro" do
    assert_difference('Registro.count') do
      post registros_url, params: { registro: { apellido: @registro.apellido, correo: @registro.correo, nombre: @registro.nombre, telefono: @registro.telefono, usuario: @registro.usuario } }
    end
  ...
  test "should update registro" do
    patch registro_url(@registro), params: { registro: { apellido: @registro.apellido, correo: @registro.correo, nombre: @registro.nombre, telefono: @registro.telefono, usuario: @registro.usuario } }
